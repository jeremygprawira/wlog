...
- [x] 11-HTTP-5 Problem responses, edge cases, benchmark, and docs
...
- [x] 11-MIG-1 Migrate log outputs, trace-otel, examples, and the CLI to v2 names
- [x] Review point 11, v0.6.0: human review, then ask before tagging
...
- [x] 12-A-9 http-huma and rpc-twirp
- [x] 12-A-10 Recipes: rest-api and grpc-service
- [x] 12-B-1 sqlshape
- [x] 12-B-2 client-http
- [x] 12-B-3 store-sql
- [x] 12-B-4 store-pgx and store-gorm
- [x] 12-B-5 store-redis
- [x] 12-B-6 store-mongo and client-aws
- [x] 12-B-7 store-bun
- [x] 12-C-1 log-slog
- [x] 12-C-2 log-logr and log-zap
- [x] 12-C-3 log-zerolog, log-logrus, and log-hclog
- [x] 12-C-4 log-std
- [x] 12-C-5 errors-validator and errors-oops
- [x] 12-C-6 errors-cockroach and flag-openfeature
...
- [x] 13-D-2 queue-sarama and queue-franz
- [x] 13-D-3 queue-confluent
- [x] 13-D-4 queue-watermill
- [x] 13-D-5 queue-sqs
