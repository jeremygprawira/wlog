...
func TestRuleOrder(t *testing.T) {
	...
	want := []string{rules.RuleMiddleware, rules.RuleContext, rules.RuleErrors, rules.RuleErrorGuidance, rules.RuleSwallowedError, rules.RuleNoPrint, rules.RuleNoDenylisted}
